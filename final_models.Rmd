...
# createDataPartition will give 70% of total data rows with same class ratio as in given data set.
# I removed the column no 1 to 7 in both the training and testing data sets because they will not contribute to prediction.  
